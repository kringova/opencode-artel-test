...
- [x] Команда `add "Купить молоко"` добавляет задачу
- [x] Команда `list` выводит все задачи с номерами
- [x] Скрипт запускается: `python todo.py add "тест"` и `python todo.py list`
